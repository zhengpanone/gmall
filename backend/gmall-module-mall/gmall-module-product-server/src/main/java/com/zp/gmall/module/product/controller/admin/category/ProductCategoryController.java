...
public class ProductCategoryController {
    ...
    public Result<?> createCategory(@Valid @RequestBody ProductCategoryDTO productCategoryDTO) {
    ...
    public Result<?> updateCategory(@Valid @RequestBody ProductCategoryDTO productCategoryDTO) {
        categoryService.updateCategory(productCategoryDTO);
        return Result.ok();
    }
    ...
    public Result<?> deleteCategory(@Valid @RequestBody Ids ids) {
    ...
    public PageResult<ProductCategoryVO> getCategoryPage(@Valid ProductCategoryPageDTO productCategoryPageDTO) {
        return categoryService.getCategoryPage(productCategoryPageDTO);
    }
}
