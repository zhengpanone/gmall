...
//        return new Parameter().name(HttpHeaders.AUTHORIZATION).description("认证 Token")
//                .in(String.valueOf(SecurityScheme.In.HEADER)).schema(new StringSchema()._default("Bearer test1").name(HEADER_TENANT_ID).description("认证 Token"));
//    }
//}
