 ...
 * @RequiredArgsConstructor：生成该类下被final修饰或者带有@NonNull的构造方法。 使用@AllArgsConstructor之后，@Value就会不起作用
...
public class AuthController {
    ...
    public Result<AuthPermissionInfoVO> getPermissionInfo() {
        String userId = SecurityFrameworkUtils.getLoginUserId();
        return ok(authService.getPermissionInfo(userId));
    }
