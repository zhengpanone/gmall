package com.zp.gmall.module.system.api.logger.dto;
...
public class LoginLogDTO {
    ...
    @Schema(description = "登录结果,参见LoginResultEnum枚举类", example = "1")
    ...
    @Schema(description = "浏览器UserAgent", example = "Mozilla/5.0")
