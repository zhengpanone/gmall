...
public class SortBenchmarkTest3 {
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder().include(SortBenchmarkTest3.class.getSimpleName()) // 要导入的测试类
                .result("SortBenchmarkTest3.json")
                .mode(Mode.All)
