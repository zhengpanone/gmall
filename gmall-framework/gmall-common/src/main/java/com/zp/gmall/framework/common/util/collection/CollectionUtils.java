package com.zp.gmall.framework.common.util.collection;
...
public class CollectionUtils {
    ...
    public static <T, K, V> Map<K, List<V>> convertMultiMapList(Collection<T> from, Function<T, K> keyFunc, Function<T, V> valueFunc) {
        if (CollUtil.isEmpty(from)) {
            return new HashMap<>();
        }
        return from.stream()
