...
import com.zp.framework.apilog.core.enums.OperateTypeEnum;
...
import static com.zp.framework.apilog.core.interceptor.ApiAccessLogInterceptor.*;
import static com.zp.framework.common.util.json.JsonUtils.toJsonString;
...
public class ApiAccessLogFilter extends ApiRequestFilter {
    ...
    private boolean buildApiAccessLog(ApiAccessLogCreateReqDTO accessLog, HttpServletRequest request, LocalDateTime beginTime,
        ...
        // 设置访问结果
        Result<?> result = WebFrameworkUtils.getResult(request);
        if (result != null) {
    ...
    private static String sanitizeJson(Result<?> commonResult, String[] sanitizeKeys) {
