<template>
	<el-form size="large" class="login-content-form" ref="accountForm" :model="state.ruleForm" :rules="state.rules">
		<el-form-item class="login-animation1" prop="username">
			<el-input text :placeholder="$t('message.account.accountPlaceholder1')" v-model.trim="state.ruleForm.userName"
...
const state = reactive({
	...
	rules: {
		username: [{ requried: true, message: '账号不能为空', trigger: 'blur' }],
