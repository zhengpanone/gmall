...
public class SpringDocConfig {
    ...
    private static final String basePackage = "com.zp.gmall.module.infra";
    // 请求头名称
    private static final String headerName = "token";

    @Bean
    public GroupedOpenApi buildGroupedOpenApi() {
        return GroupedOpenApi.builder().group("infraGroup").addOperationCustomizer((operation, handlerMethod) -> {
    ...
    private Info apiInfo() {
        ...
        return new Info().title("基础服务管理接口文档")
