...
CREATE TABLE IF NOT EXISTS "sys_social_client"
(
    "id"            bigint       NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS "sys_social_user_bind"
(
    "id"          bigint    NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "user_id"     bigint    NOT NULL,
    "user_type"   tinyint   NOT NULL,
...
-- 将该建表 SQL 语句，添加到 yudao-module-sys-biz 模块的 test/resources/sql/create_tables.sql 文件里
