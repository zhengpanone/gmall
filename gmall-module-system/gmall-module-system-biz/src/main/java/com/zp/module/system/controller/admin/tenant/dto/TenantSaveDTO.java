package com.zp.module.system.controller.admin.tenant.dto;
...
/**
 * Author : zhengpanone
 * Date : 2024/8/30 12:43
 * Version : v1.0.0
 * Description: 租户创建/修改DTO
 */
@Schema(description = "管理后台 - 租户创建/修改 Request DTO")
@Data
public class TenantSaveDTO {
    ...
    public boolean isUsernameValid() {
        // 修改时，不需要传递  新增时，必须都传递 username、password
