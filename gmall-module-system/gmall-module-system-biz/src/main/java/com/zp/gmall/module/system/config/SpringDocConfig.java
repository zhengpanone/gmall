...
public class SpringDocConfig {
    ...
    private static final String basePackage = "com.zp.gmall.module.system";
    // 请求头名称
    private static final String headerName = "token";

    @Bean
    public GroupedOpenApi buildGroupedOpenApi() {
        return GroupedOpenApi.builder().group("systemGroup").addOperationCustomizer((operation, handlerMethod) -> {
    ...
    private Info apiInfo() {
        ...
        return new Info().title("系统管理接口文档")
